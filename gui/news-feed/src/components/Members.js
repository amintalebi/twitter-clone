            ...
            >
                {
                    accounts.map((account , index) => (
                        <Member
                            key={index}
                            banMember={() => accounts.splice(index, 1)}
                            deleteMember={() => accounts.splice(index, 1)}
                        />
                    ))
                }
            </InfiniteScroll>
...
export default withStyles(styles)(connect(mapStateToProps, mapDispatchToProps)(Members));
