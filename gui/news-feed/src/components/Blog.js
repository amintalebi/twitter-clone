...
const mainFeaturedPost = {
  ...
  description: "توضیحی مختصر از پست منتخب اصلی",
...
const featuredPosts = [
  {
    title: "پست منتخب",
    date: "۵ دی",
    description: "توضیحی مختصر درباره‌ی پست منتخب",
    image: "https://source.unsplash.com/random",
  ...
  },
  {
    title: "عنوان پست",
    date: "۹ دی",
    description: "توضیح مختصر درباره‌ی پست",
    image: "https://source.unsplash.com/random",
    imageText: "Image Text"
  }
];
...
const sidebar = {
  title: "درباره‌ی سایت",
  description: "سایتی برای دنبال کردن اخبار و به اشتراک گذاری آن‌ها",
  archives: [
...
export default function Blog() {
  ...
  return (
    <React.Fragment>
      ...
      <Footer
        title="اخبار"
        description="ساخته شده با عشق در دانشگاه صنعتی شریف"
      />
    </React.Fragment>
  );
}
